...
@section('content-header')
    ...
    {!! Breadcrumbs::render('order_search') !!}
@endsection
@section('content')
    <div class="box-body">
        <div class="row">
            <div class="col-xs-3">
                <input type="text" class="form-control" placeholder="订单号查询">
            </div>
            <div class="col-xs-3">
                <input type="text" class="form-control" placeholder="预定人查询">
            </div>
            <div class="col-xs-3">
                <input type="text" class="form-control" placeholder="民宿查询">
            </div>
