        ...
        <form role="form" method="POST" action="{{ route('user.update',$user->id) }}">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label>*用户名</label>
                    <input type="text" required="required" class="form-control" name="name" value="{{ $user->name }}" placeholder="请输入用户名">
                </div>
                <div class="form-group">
                    <label>*用户email</label>
                    <input type="email" required="required" class="form-control" name="email" value="{{ $user->email }}" placeholder="请输入用户邮箱">
                </div>
                <div class="form-group">
                    <label>密码*</label>
