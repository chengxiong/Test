            ...
            <div class="box-header">
                ...
                <div class="col-sm-6">
                    <div class="dataTables_filter" id="example1_filter">
                        <a href="<?php echo e(route('user.create')); ?>" class="btn bg-olive">添加用户</a>
                    </div>
                </div>
            </div>
            <div class="box-body">
                            ...
                            <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                                ...
                                <?php foreach($user_list as $user): ?>
                                    <tr role="row" class="odd">
                                        ...
                                        <td>
                                            <?php if($user->id >= 2): ?>
                                            <a href="<?php echo e(route('user.edit',$user->id)); ?>">编辑</a>
                                            <a href="<?php echo e(route('user.role',$user->id)); ?>">角色</a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
